(function (u, h) {
    typeof exports == "object" && typeof module < "u"
        ...
        : typeof define == "function" && define.amd
          ...
          : ((u = typeof globalThis < "u" ? globalThis : u || self), h((u["leaflet-control-geocoder"] = {}), u.L));
})(this, function (u, h) {
    "use strict";
    function N(i) {
    ...
    function W(i) {
        return i == null ? "" : i ? ((i = "" + i), A.test(i) ? i.replace(D, z) : i) : i + "";
    }
    function c(i, e) {
        const t = {
    ...
    function I(i, e) {
        return i.replace(/\{ *([\w_]+) *\}/g, (t, s) => {
            let o = e[s];
            return o === void 0 ? (o = "") : typeof o == "function" && (o = o(e)), W(o);
        });
    }
    class v {
        options = {
        ...
        async geocode(e) {
            ...
            return (await c(this.options.serviceUrl + "/findAddressCandidates", t)).candidates.map((o) => {
    ...
    class y {
        ...
        _parseResults(e) {
            return (e.results || [])?.map((t) => {
                const s = new n.LatLng(t.geometry.location.lat, t.geometry.location.lng),
                    o = new n.LatLngBounds(
                        new n.LatLng(t.geometry.viewport.northeast.lat, t.geometry.viewport.northeast.lng),
                        new n.LatLng(t.geometry.viewport.southwest.lat, t.geometry.viewport.southwest.lng)
                    );
                return {
    ...
    class x {
        ...
        async getJSON(e, t) {
            return ((await c(e, t)).response.view?.[0]?.result || []).map((o) => {
                const r = o.location,
                    a = new n.LatLng(r.displayPosition.latitude, r.displayPosition.longitude),
    ...
    function R(i) {
        ...
        if ((e = i.match(/^([NS])\s*(\d{1,3}(?:\.\d*)?)\W*([EW])\s*(\d{1,3}(?:\.\d*)?)$/)))
            return new n.LatLng((/N/i.test(e[1]) ? 1 : -1) * +e[2], (/E/i.test(e[3]) ? 1 : -1) * +e[4]);
        if ((e = i.match(/^(\d{1,3}(?:\.\d*)?)\s*([NS])\W*(\d{1,3}(?:\.\d*)?)\s*([EW])$/)))
            return new n.LatLng((/N/i.test(e[2]) ? 1 : -1) * +e[1], (/E/i.test(e[4]) ? 1 : -1) * +e[3]);
        if (
            (e = i.match(
            ...
            return e.features?.length
                ? e.features.map((t) => {
                      ...
                      return (
                          t.bbox
                              ? (o = new n.LatLngBounds(
                                    new n.LatLng(...t.bbox.slice(0, 2).reverse()),
                                    new n.LatLng(...t.bbox.slice(2, 4).reverse())
                                ))
            ...
            htmlTemplate(e) {
                ...
                return (
                    ...
                    (t.city || t.town || t.village || t.hamlet) &&
                        ((s = o.length > 0 ? "leaflet-control-geocoder-address-detail" : ""),
                        o.push('<span class="' + s + '">{postcode} {city} {town} {village} {hamlet}</span>')),
                    (t.state || t.country) &&
                        ((s = o.length > 0 ? "leaflet-control-geocoder-address-context" : ""),
                        o.push('<span class="' + s + '">{state} {country}</span>')),
                    I(o.join("<br/>"), t)
                );
            },
        };
                ...
                return [
                    {
                        ...
                        center: new n.LatLng(e.lat, e.lng),
                        bbox: new n.LatLngBounds(new n.LatLng(e.lat, e.lng), new n.LatLng(e.lat, e.lng)),
                    },
                ];
            } catch (s) {
                ...
                const s = t.geometry.coordinates,
                    ...
                    r =
                        Array.isArray(t.bbox) && t.bbox.length === 4
                            ? new n.LatLngBounds([t.bbox[1], t.bbox[0]], [t.bbox[3], t.bbox[2]])
        ...
        _parseResults(e) {
            return (e.features || []).map((t) => {
                const s = t.geometry.coordinates,
                    ...
                    a = r ? new n.LatLngBounds([r[1], r[0]], [r[3], r[2]]) : new n.LatLngBounds(o, o);
                return {
    ...
    Object.getOwnPropertyNames(n.Control.prototype).forEach((i) => (f.prototype[i] = n.Control.prototype[i])),
        Object.getOwnPropertyNames(n.Evented.prototype).forEach((i) => (f.prototype[i] = n.Evented.prototype[i]));
    class m extends f {
        options = {
            showUniqueResult: !0,
            showResultIcons: !1,
        ...
        _suggestTimeout;
        constructor(e) {
            super(e), n.Util.setOptions(this, e), this.options.geocoder || (this.options.geocoder = new L());
        }
        addThrobberClass() {
        ...
        onAdd(e) {
            ...
            return (
                ...
                (this._errorElement = n.DomUtil.create("div", t + "-form-no-error", s)),
                ...
                this.options.geocoder?.suggest && n.DomEvent.on(a, "input", this._change, this),
                ...
                this.options.collapsed
                    ...
                    : (this._expand(),
                      n.Browser.touch
                          ? n.DomEvent.on(s, "touchstart", () => this._geocode())
            ...
            !t && this.options.showUniqueResult && e.length === 1
                ...
                : e.length > 0
                  ? ((this._alts.innerHTML = ""),
                    ...
                    this._results.forEach((s, o) => this._alts.appendChild(this._createAlt(s, o))))
        ...
        async _geocode(e = !1) {
            ...
            const r = {
                ...
                a = e ? await this.options.geocoder.suggest(t, r) : await this.options.geocoder.geocode(t, r);
            if (s === this._requestCount) {
                const d = {
                    input: t,
                    results: a,
                };
                this.fire(e ? "finishsuggest" : "finishgeocode", d), this._geocodeResult(a, e);
            }
        }
        ...
        _createAlt(e, t) {
            const s = n.DomUtil.create("li", ""),
                ...
                r = this.options.showResultIcons && e.icon ? n.DomUtil.create("img", "", o) : null,
        ...
        _keydown(e) {
            const t = (s) => {
                this._selection &&
                    ...
                    (this._selection = this._selection[s > 0 ? "nextSibling" : "previousSibling"])),
                    this._selection || (this._selection = this._alts[s > 0 ? "firstChild" : "lastChild"]),
                    this._selection && this._selection.classList.add("leaflet-control-geocoder-selected");
            };
            switch (e.key) {
                case "Escape":
                    this.options.collapsed ? this._collapse() : this._clearResults();
        ...
        _change() {
            ...
            e !== this._lastGeocode &&
                ...
                e.length >= this.options.suggestMinLength
                    ? (this._suggestTimeout = setTimeout(() => this._geocode(!0), this.options.suggestTimeout))
                    : this._clearResults());
        }
    }
    function M(i) {
